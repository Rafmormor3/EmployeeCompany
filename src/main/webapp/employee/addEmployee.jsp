...
<%
	...
	try{
		...
		if(request.getParameter("submit")!= null){
			...
			empleado = new Employee(name, lastName, email, gender, dateOfBirth, company);
			DbRepository.add(empleado);	
		}
...
<form action="" id="formulario">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        <input id="gender" name="gender" type="text" required="required" class="form-control"> 
      </div>
    </div>
  </div>
    <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        <input id="dateOfBirth" name="dateOfBirth" type="date" required="required" class="form-control"> 
      </div>
    </div>
  </div>
  <div class="form-group row">
